    ...
    <div className=" flex items-center justify-center py-2">
      ...
      >
        ...
        <div class="hero-content text-center text-neutral-content py-24">
          <div class="max-w-lg">
            <h1 class="mb-5 text-5xl font-bold  title ">Join Our Book Club</h1>
            <p class="mb-5">
              Join Our Book Club. It's a coummuity for books lover. we can discus every user about to books details. 
            </p>
