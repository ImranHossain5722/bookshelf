...
const AddStuff = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      "https://bookshelf-server-s8lf.onrender.com/get-all-users-email",
      options
    )
  ...
  useEffect(() => {
    const options = {
      method: "GET",
      url: `https://bookshelf-server-s8lf.onrender.com/get-user-by-email?email=${userEmail}`,
    };
  ...
  return (
    <div className="pt-12 pb-12 w-1/2 mx-auto">
      ...
      <div className="w-full mb-6">
        ...
        <Select
          onChange={(choice) => getUserDatas(choice)}
          className="mt-2 rounded-xl"
          options={userByEmailOption}
        />
      </div>
      <form className="mb-2" onSubmit={handleSubmit(onSubmit)}>
        <Select
          onChange={(choice) => getChoosenRole(choice)}
          name="role"
      ...
      <div className="md:flex mt-8">
        ...
        <div className=" md:w-[70%] mt-12 md:mt-0  md:ml-12">
          <div className="form-control w-full ">
            ...
            <p className="p-3 text-gray-700 bg-[#EDE8E8] rounded-md ">
              {stuffData?.user_name}
            </p>
          </div>
