...
const Addreview = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post("https://bookshelf-server-s8lf.onrender.com/add-review", review)
  ...
  return (
    <div>
      ...
      <div className="bg-base-100 flex justify-around">
        <div className="mt-20">
          <img
            src="https://i.ibb.co/q0r29PV/1575376469213-employee-evaluation-form.jpg"
            ...
            <div className="flex justify-center gap-7">
              <div>
                ...
                <input
                  ...
                  disabled={true}
                  className="input input-bordered bg-white w-full max-w-xs mt-2"
                />
              </div>
              <div>
