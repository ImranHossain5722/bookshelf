...
const UpdateProduct = () => {
    ...
    const { isLoading, error, data: book, refetch } = useQuery(['getBook'], () =>
        fetch(`https://book-shelf-webapp.herokuapp.com/get-book?id=${bookid}`).then(res =>
            res.json()
        )
    )
                    ...
                    <div className='md:flex'>
                        <div className='md:w-[30%]'>
                            ...
                            <div className="previewProfilePic">
                                <img className="playerProfilePic_home_tile max-w-[100%] mx-auto max-h-[300px] rounded-3xl" src={imgData ? imgData : book[0]?.book_cover_photo_url} alt='' />
                            </div>
                        </div>
                        <div className='md:w-[70%] mt-12 md:mt-0  md:ml-12'>
                            <div className='md:flex gap-7'>
                                <div className='w-full'>
                                    ...
                                    <input type="text" {...register("book_title",
                                        ...
                                        defaultValue={book[0]?.book_title}
                            ...
                            <div className='md:flex gap-7 mt-4' >
                                <div className='w-full'>
                                    ...
                                    <input type="number" {...register("book_price", {
                                        ...
                                        defaultValue={book[0]?.book_price}
                                        min={1}
                                        className="input-bordered rounded-[4px] border-[1px] border-[#DBDBDB] p-[7px] placeholder:text-[14px] bg-white w-full mt-2" />
                                ...
                                <div className='w-full'>
                                    ...
                                    <input type="number" {...register("book_pages", {
                                        ...
                                        defaultValue={book[0]?.book_pages}
                            ...
                            <div className='md:flex gap-7 mt-4' >
                                ...
                                <div className='w-full'>
                                    ...
                                    <input type="text" {...register("book_edition", {
                                        ...
                                        defaultValue={book[0]?.book_edition}
                            ...
                            < div className='md:flex gap-7 mt-4' >
                                <div className='w-full'>
                                    ...
                                    <input type="text" {...register("translator", {
                                        ...
                                        defaultValue={book[0]?.book_language}
                                        className="input-bordered rounded-[4px] border-[1px] border-[#DBDBDB] p-[7px] placeholder:text-[14px] bg-white w-full mt-2" />
                                ...
                                <div className='w-full mt-4  md:mt-0'>
                                    ...
                                    <input type="text" {...register("country", {
                                        ...
                                        defaultValue={book[0]?.book_country}
                                        className="input-bordered rounded-[4px] border-[1px] border-[#DBDBDB] p-[7px] placeholder:text-[14px] bg-white w-full mt-2" />
                            ...
                            < div className='mt-4' >
                                ...
                                <textarea type="text" {...register("book_description", {
                                    ...
                                    defaultValue={book[0]?.book_description}
