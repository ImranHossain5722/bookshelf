                        ...
                        <div className='md:flex'>
                            <div className='md:w-[30%]'>
                                ...
                                <div className="previewProfilePic">
                                    <img className="playerProfilePic_home_tile max-w-[100%] mx-auto max-h-[auto] rounded-3xl" src={imgData ? imgData : book && book[0]?.book_cover_photo_url} alt='' />
                                </div>
                            </div>
                            <div className='md:w-[70%] mt-12 md:mt-0  md:ml-12'>
                                ...
                                <div className='md:flex gap-7 mt-4'>
                                    <div className='w-full'>
                                        ...
                                        <Select
                                            defaultValue={{ label: book && book[0]?.book_author?.author_name, value: book && book[0]?.book_author?._id, }}
                                    ...
                                    <div className='w-full mt-4 md:mt-0'>
                                        ...
                                        <Select
                                            defaultValue={{ label: book && book[0]?.book_publisher?.publisher_name, value: book && book[0]?.book_publisher?._id, }}
