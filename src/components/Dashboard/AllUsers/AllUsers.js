  ...
  return (
    <div className="bg-base-100 my-8 p-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  justify-center items-center">
        {users?.map((user) => (
          <div className="mx-[12px] card user-shadow  w-[320px] h-[135px] p-7 font-semibold m-3 bg-white">
            <p className="pl-8 relative bottom-2 text-secondary text-lg font-semibold capitalize ">
              {user.user_name}
            </p>
            <div className="flex items-center">
              ...
              <div className="">
                <p className="flex items-center break-all">
                  <IoMdMail className="text-[#B7B7B7] text-[16px] mr-4" />
                  {user.user_email}
                </p>
                <p className="flex items-center">
                  <MdPhoneInTalk className="text-[#B7B7B7] text-[16px] mr-4" />
                  {user.user_phone ? user.user_phone : "+8801xxxxx"}
                </p>
              </div>
            </div>
          </div>
