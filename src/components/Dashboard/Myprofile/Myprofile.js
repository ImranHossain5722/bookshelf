...
const Myprofile = () => {
  ...
  const onSubmit = (data) => {
    ...
    if (user?.email) {
      axios
        .put(
          "https://book-shelf-webapp.herokuapp.com/update-user",
          updatedProfileData
        )
        .then((data) => toast.success(`Profile update Successfully`));
    }
  };
  ...
  return (
    <div>
      ...
      <div className="md:flex  mr-auto mx-[20px] md:ml-20">
        <div className="md:w-[50%] p-[20px] md:p-[78px] rounded-xl shadow-lg drop-shadow-lg text-black bg-white">
          <img
            ...
            src={
              user?.photoURL
                ? user?.photoURL
                : "https://i.ibb.co/DQSNSHK/user.png "
            }
            alt=""
          />
          <h2 className="text-[20px] font-semibold mt-3 mb-1 text-center text-black">
            {user?.displayName}
          </h2>
          <p className="text-center mb-3 text-[20px]">
            {userRole === "user" ? "Customer" : userRole}
          </p>
          <h3 className="font-bold text-[25px] mb-[19px] text-secondary uppercase">
            Contact Informatin
          </h3>
          <div>
            <h4 className="font-[600] text-[20px] py-[7px] text-secondary ">
              Email Address
            </h4>
            <p className="font-[600] text-[16px] py-[7px]">{user?.email}</p>
          </div>
          <div>
            <h4 className="font-[600] text-[25px] py-[7px] text-secondary  ">
              Phone Number{" "}
            </h4>
        ...
        <div className="p-[20px] md:p-12 pt-0 md:ml-6 md:w-[50%] bg-white rounded-md mx-4">
          {/* cards  */}
          {/* card raw container */}
          {userRole === "user" && (
              ...
              <div className="flex mx-auto py-2 ">
                <div className=" flex-1 ">
                  <div className="form-control w-full">
                    <h2 className="font-semibold uppercase text-secondary pt-5 text-[20px]">
                      Update Profile
                    </h2>
                    <div className=" pb-2">
                      <progress className="progress progress-primary bg-white h-1 w-5  "></progress>
                    </div>
                    ...
                    <input
                      ...
                      className="input input-bordered w-full bg-[#0000001a] text-secondary"
                    />
                    <label className="label">
                  ...
                  <div className="form-control w-full ">
                    ...
                    <input
                      ...
                      type="file"
                      placeholder="Update Your Address"
                      className="input input-bordered w-full pt-[5px] bg-[#0000001a] text-secondary"
                    />
                    <label className="label">
                      <span className="label-text-alt text-red-500">
