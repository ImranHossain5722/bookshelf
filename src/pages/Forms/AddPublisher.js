        ...
        <div className=' justify-center items-center py-12'>
            <div className="card bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className='text-center font-bold text-3xl mb-3'>Became a Publisher</h2>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className='flex'>
                            <div>
                                <div className="form-control w-full">
                                    ...
                                    <label className="label">
                                        <span className="label-text-alt text-red-500">{errors.company?.type === 'required' && `${errors?.company?.message}`}</span>
                                    </label>
                                </div>
                                <div className="form-control w-full max-w-sm">
                                    <label className="label">
                                        <span className="label-text text-lg">Key Person Name</span>
                                    </label>
                                    <input
                                        {...register("person", {
                                            required: {
                                        ...
                                        className="input input-bordered w-full max-w-xs bg-secondary text-white" />
                                    <label className="label">
                                        <span className="label-text-alt text-red-500">{errors.person?.type === 'required' && `${errors?.person?.message}`}</span>
                                    </label>
                                </div>
                                <div className="form-control w-full max-w-sm">
                                    <label className="label">
                        ...
                        <input type="submit" className='btn btn-primary text-white w-full' value='Became a Publisher' />
                    </form>
