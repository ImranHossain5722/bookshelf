    ...
    <div className="pt-[60px] md:pt-[80px] lg:pt-[120px]  pb-[60px] md:pb-[80px] lg:pb-[120px] ">
      <div className="container m-auto flex gap-6">
        <div className="w-full lg:w-4/12 xl:w-3/12">
          ...
          <div className="p-8 border ">
            <div className="single_category mb-6">
              <h4 className="text-black text-[18px] font-medium pb-2 border-b-[1px]  border-[#e1e2e6] mb-3">
                Product categories
              </h4>
              <div className="categories_box">
                <label className="label cursor-pointer justify-start gap-2">
                  <input type="checkbox" checked="checked" className="checkbox" />
                  <span className="label-text text-black">Clothing</span>
                </label>
                <label className="label cursor-pointer justify-start gap-2">
                  <input type="checkbox" checked="checked" className="checkbox" />
                  <span className="label-text text-black">Clothing</span>
        ...
        <div className="w-full lg:w-8/12 xl:w-9/12">
          <h3 className="text-black text-[16px] capitalize font-semibold pb-4 border-b-[1px] border-[#e1e2e6] mb-12">
